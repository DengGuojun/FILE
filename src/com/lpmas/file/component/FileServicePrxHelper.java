...
public final class FileServicePrxHelper extends Ice.ObjectPrxHelperBase implements FileServicePrx
{
    ...
    {
        com.lpmas.file.component.FileServicePrx __proxy = (com.lpmas.file.component.FileServicePrx)__result.getProxy();
        String __ret = null;
        try
        {
    ...
    public static FileServicePrx checkedCast(Ice.ObjectPrx __obj)
    {
        return checkedCastImpl(__obj, ice_staticId(), FileServicePrx.class, FileServicePrxHelper.class);
    }

    public static FileServicePrx checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        return checkedCastImpl(__obj, __ctx, ice_staticId(), FileServicePrx.class, FileServicePrxHelper.class);
    }

    public static FileServicePrx checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        return checkedCastImpl(__obj, __facet, ice_staticId(), FileServicePrx.class, FileServicePrxHelper.class);
    }

    public static FileServicePrx checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        return checkedCastImpl(__obj, __facet, __ctx, ice_staticId(), FileServicePrx.class, FileServicePrxHelper.class);
    }

    public static FileServicePrx uncheckedCast(Ice.ObjectPrx __obj)
    {
        return uncheckedCastImpl(__obj, FileServicePrx.class, FileServicePrxHelper.class);
    }

    public static FileServicePrx uncheckedCast(Ice.ObjectPrx __obj, String __facet)
    {
        return uncheckedCastImpl(__obj, __facet, FileServicePrx.class, FileServicePrxHelper.class);
    }

    public static final String[] __ids =
    {
        "::Ice::Object",
        "::com::lpmas::file::component::FileService"
    };
    ...
    public static void __write(IceInternal.BasicStream __os, FileServicePrx v)
    {
        __os.writeProxy(v);
    }

    public static FileServicePrx __read(IceInternal.BasicStream __is)
    {
        Ice.ObjectPrx proxy = __is.readProxy();
        if(proxy != null)
        {
            FileServicePrxHelper result = new FileServicePrxHelper();
